/**
 * =============================================================================
 * FILE: database/repositories/index.ts
 * LAYER: DATA ACCESS
 * =============================================================================
 * 
 * PURPOSE:
 * Central export point for all repository modules.
 * Provides a clean import interface for the backend domain layer.
 * 
 * USAGE:
 * import { officerRepository, inspectionRepository } from "../../database/repositories";
 * 
