...
export default function InspectionsScreen() {
  ...
  const filterInspections = (data: Inspection[], query: string, status: string) => {
    let filtered = data;
  ...
  const renderInspection = ({ item, index }: { item: Inspection; index: number }) => (
  ...
  const renderEmptyState = () => (
    <EmptyState
      ...
      actionLabel={!searchQuery && statusFilter === 'all' ? 'New Inspection' : undefined}
      onAction={
        !searchQuery && statusFilter === 'all'
