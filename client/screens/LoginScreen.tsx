    ...
    <View style={[styles.container, { backgroundColor: theme.primary }]}>
      ...
      >
        <View style={styles.header}>
          ...
          <ThemedText type="body" style={[styles.subtitle, { color: 'rgba(255,255,255,0.8)' }]}>
        ...
        <View style={[styles.card, { backgroundColor: theme.backgroundDefault }]}>
          ...
          <ThemedText type="small" style={[styles.helpText, { color: theme.textSecondary }]}>
            This is an invite-only system. Contact your administrator if you need access.
          </ThemedText>
        </View>

        <ThemedText type="small" style={[styles.footer, { color: 'rgba(255,255,255,0.6)' }]}>
